...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder(self, x, timestamps, mask_ratio, valid_patch_mask, mask=None):
        ...
        x, mask, ids_restore = self.random_masking(x, mask_ratio, valid_patch_mask, mask=mask)
    ...
    def forward(self, imgs, timestamps, mask_ratio=0.75, mask=None):
        ...
        latent, mask, ids_restore = self.forward_encoder(x, timestamps, mask_ratio, valid_patch_mask, mask=mask)
